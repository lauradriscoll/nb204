...
% them directly using a double-y axis plot
figure
yyaxis left
plot(expTime,cumResid);
xlabel('Time (s)');
...
% Q1: What is the pattern here?
% A1: residuals get bigger as rat moves in positive direction and smaller
% as he moves in the negative direction.
% Q2: What would we expect for the correct model? 
% A2: 0 mean and no correlation w/ covariates
